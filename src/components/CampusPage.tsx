...
export default function CampusPage() {
  ...
  <div className="flex items-start justify-between mb-8">
    ...
    <ProfileButton />
            ...
            >
              ...
              <div className="relative z-10 flex justify-between items-start">
                ...
                <div className="flex gap-2 relative z-20">
                  <button
                    className="p-2 rounded-lg bg-white/10 hover:bg-yellow-400/20 text-yellow-300 transition"
                    title="Edit Campus"
                  >
                    <Pencil size={16} />
                  </button>
                  <button
                    className="p-2 rounded-lg bg-white/10 hover:bg-red-500/20 text-red-300 transition"
                    title="Delete Campus"
                  >
                    <Trash2 size={16} />
                  </button>
      ...
      <button
        className="fixed bottom-8 right-8 z-50 w-16 h-16 rounded-full bg-gradient-to-r from-yellow-400 to-amber-500 text-green-950 shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center"
        title="Add Campus"
      >
        <Plus size={28} />
      </button>
