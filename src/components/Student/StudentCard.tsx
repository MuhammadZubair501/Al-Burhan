...
interface StudentCardProps {
  ...
  name: string;
  address: string;
  onViewDetails?: (Student: { id: string | number; name: string; address: string; image: string }) => void;
  onEdit?: (Student: { id: string | number; name: string; address: string; image: string }) => void;
  onDelete?: (Student: { id: string | number; name: string; address: string; image: string }) => void;
  onAdd?: () => void;
}
...
export default function StudentAndStudentCard({
  ...
  const StudentData = { id, image, name, address };
...
>
  ...
  <div className="grid grid-cols-2 gap-3 mt-5">
    <div className="rounded-2xl bg-white/5 border border-white/10 p-3 text-center">
      ...
      <p className="text-white font-semibold">Grade 5</p>
    </div>
