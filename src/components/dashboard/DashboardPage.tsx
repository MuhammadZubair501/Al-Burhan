...
export default function DashboardPage() {
  ...
  const saveScrollPosition = useCallback(() => {
    if (scrollContainerRef.current) {
      const container = scrollContainerRef.current.closest('.overflow-auto');
      if (container) {
        sessionStorage.setItem('dashboardScrollPosition', String(container.scrollTop));
      }
    }
  }, []);
  ...
  // Reset first render flag after mount
  useEffect(() => {
    ...
    <div className="min-h-screen">
      <div className="relative overflow-hidden">
        ...
        <div 
          ...
          className="relative z-10 p-3 sm:p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto"
        >
            ...
            <>
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 mb-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  {loading && (
                    <span className="text-xs text-green-100/50 animate-pulse">(Updating...)</span>
                  )}
                </div>
